...
---
### 차별성 & 구매 합리성
- 차별점: 경쟁 제품 비교가 리뷰에서 다뤄지지 않아 차별성 판단 정보 부족
- 감안할 점: 가격 합리성 평가는 리뷰에서 다루지 않음
...
'### 차별성 & 구매 합리성' 섹션은 반드시 '- 차별점: ...' 와 '- 감안할 점: ...' 두 라벨로 시작하는 불릿만 사용하세요 (그룹당 1~2개, 총 2~4개). 자막에 경쟁 제품 비교나 가격 합리성 근거가 없으면 해당 그룹은 '차별점: ... 정보 부족' / '감안할 점: ... 평가 없음' 한 줄로 표기하세요.
